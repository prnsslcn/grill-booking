      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-4">
        ...
        <div
          className={`nav-drop-in absolute z-20 flex flex-col border px-6 transition-all duration-500 ease-out sm:px-8 ${
            mobileOpen
              ? 'inset-x-0 top-0 rounded-b-[1.5rem] border-transparent bg-[#e8ebf0]/80 backdrop-blur-md md:inset-x-4 md:top-4 md:rounded-[1.5rem] md:border-line md:bg-surface/80 md:backdrop-blur-xl'
              : solid
                ? 'inset-x-0 top-0 rounded-b-[1.5rem] border-transparent bg-[#e8ebf0]/80 backdrop-blur-md sm:inset-x-4 sm:top-4 sm:rounded-[1.5rem] sm:border-white/40 sm:bg-surface/70 sm:backdrop-blur-xl md:rounded-full'
                : 'inset-x-0 top-0 rounded-b-[1.5rem] border-transparent bg-[#e8ebf0]/80 backdrop-blur-md sm:inset-x-4 sm:top-4 sm:rounded-[1.5rem] sm:border-white/30 sm:bg-surface/55 sm:backdrop-blur-xl md:rounded-full'
          }`}
        >
