...
const FAQS: Faq[] = [
  {
    q: '언제 운영하나요?',
    a: [
      '매주 금·토요일에 운영합니다 (성수기 주중 운영(수 휴무) · 동계 휴장).',
  ...
  },
  {
    ...
    a: [
      ...
      '고기는 정원 기준 1인 150g — 6인 900g · 8인 1200g으로 제공됩니다.',
  ...
  },
  {
    q: '예약·문의는 어떻게 하나요?',
    a: [
      '온라인 [예약하기]로 진행해주시면 됩니다. 추가 문의 사항은 010-3045-2994로 문의해 주세요.',
      '단체 BBQ(최대 50명)는 사전 예약·문의로 진행됩니다. 단체 예약은 최소 일주일 전에 문의해 주세요.',
    ],
  },
        ...
        <div className="space-y-3">
          {FAQS.map((f, i) => {
            ...
            return (
              ...
              <div
                className={`rounded-[2.5rem] border bg-surface transition-colors ${
