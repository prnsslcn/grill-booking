    ...
    <div className="casestudy-text--list">
      ...
      <div>
        ...
        <div className="mission-inner_block">
          ...
          >
            <p>
              1부 17:00~19:00 / 2부 19:30~21:30, 회차당 2시간이며 전액 선결제로 예약이 확정됩니다.
            </p>
            <p>
              모든 상품에 고기세트(정원 기준 1인 150g)가 포함되고, 숯·석쇠·집게·식기·생수 등 기본
              세팅과 상추·김치·양파·버섯·소시지·쌈장 등 기본 식재료, 커피 쿠폰이 무료로 제공됩니다.
            </p>
            <p>
              한강라면·햇반은 정원 수만큼 제공되며, 라면·햇반 개수 구성은 택 1로 선택하실 수
              있습니다.
            </p>
            <p>현장에서는 개수대를 이용할 수 없는 점 참고 부탁드립니다.</p>
          </motion.div>
          <div className="mission-left_container">
      ...
      <div>
        ...
        <div className="mission-inner_block">
          ...
          >
            ...
            <p>
              예약·문의 및 단체 BBQ(최대 50명)는 010-3045-2994 (11:00~19:00)로 연락 주세요.
