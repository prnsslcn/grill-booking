...
import { adminUpdateAddon } from '@/lib/admin/actions';
...
export function AddonEditor({
  ...
  function save() {
    ...
    startTransition(async () => {
      await adminUpdateAddon(addonKey, { price: p, isActive: active });
      setSaved(true);
    });
  }
  ...
  return (
    <div className="flex flex-wrap items-center gap-4 py-4">
      <span className="w-44 font-semibold text-ink">{label}</span>
