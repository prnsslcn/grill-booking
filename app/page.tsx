              ...
              {facilities.map((f, i) => {
                ...
                return (
                  ...
                  <Link
                    ...
                    className={`squircle group relative flex aspect-[4/3] w-full flex-col justify-between overflow-hidden rounded-[3rem] p-7 transition-transform duration-300 hover:-translate-y-1.5 sm:p-8 ${s.card}`}
                  >
